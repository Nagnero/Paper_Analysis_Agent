...
- 각 주요 주장 끝에 출처 표기: `(Section X, p.Y)`
...
본문에 인용 표기 시 sourceSection과 sourcePage를 사용:
- 둘 다 있으면: `(${sourceSection}, p.${sourcePage})`
- sourceSection만 있으면: `(${sourceSection})`
- sourcePage만 있으면: `(p.${sourcePage})`
- 둘 다 null이면 표기 생략
